...
#pragma warning restore ERP023 // Only ex.Message property was observed in exception block!
        ...
        private static async Task<string> GetOrCreateDataset(PowerBIClient powerBIClient, CreateDatasetRequest dataset, IEnumerable<Dataset> existingDatasets, CancellationToken ct)
        {
            var existingDataset = existingDatasets.SingleOrDefault(d => d.Name == dataset.Name);
            if (existingDataset == null)
            {
                const DefaultRetentionPolicy retentionPolicy = DefaultRetentionPolicy.BasicFIFO;
        ...
        public static CreateDatasetRequest CreateLiveDatasetDefinition() =>
                ...
                Tables = new[]
                {
                    new Table
                    {
                        ...
                        Columns = new[]
                        {
                            ...
                            new Column { Name = "ActivePlayers", DataType = "Int64" },
                            new Column { Name = "PlayersToday", DataType = "Int64" },
                            new Column { Name = "PlayersAllTime", DataType = "Int64" }
                        }
                    }
                }
            };
                ...
                Tables = new[]
                {
                    new Table
                    {
                        ...
                        Columns = new[]
                        {
                            ...
                            new Column { Name = "Image", DataType = "String"},
                            new Column { Name = "Count", DataType = "Int64"},
                            new Column { Name = "Score", DataType = "Int64" }
                        },
                        Measures = new[]
                        {
