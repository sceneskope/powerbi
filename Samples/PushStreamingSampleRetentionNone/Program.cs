...
#pragma warning restore ERP023 // Only ex.Message property was observed in exception block!
        ...
        private static async Task RunAsync(string configurationFile, CancellationToken ct)
        {
            ...
            {
                var created = await powerBIClient.Datasets.PostDatasetAsync(dataset, DefaultRetentionPolicy.None, ct).ConfigureAwait(false);
                ...
                Tables = new[]
                {
                    new Table
                    {
                        ...
                        Columns = new[]
                        {
                            ...
                            new Column { Name = "Flag", DataType = "Boolean" },
