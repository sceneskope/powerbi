...
namespace SceneSkope.PowerBI
{
    ...
    public partial interface IDatasets
    {
        ...
        /// Default retention policy. Possible values include: 'None',
        /// 'basicFIFO'
        /// </param>
        /// <param name='customHeaders'>
        /// The headers that will be added to request.
        ...
        /// </exception>
        Task<HttpOperationResponse<object>> PostDatasetWithHttpMessagesAsync(Dataset dataset, string defaultRetentionPolicy = default(string), Dictionary<string, List<string>> customHeaders = null, CancellationToken cancellationToken = default(CancellationToken));
        /// <summary>
