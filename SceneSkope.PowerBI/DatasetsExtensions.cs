...
namespace SceneSkope.PowerBI
{
    ...
    public static partial class DatasetsExtensions
    {
            ...
            /// </param>
            public static object PostDataset(this IDatasets operations, Dataset dataset, string defaultRetentionPolicy = default(string))
            {
            ...
            /// The cancellation token.
            /// </param>
            public static async Task<object> PostDatasetAsync(this IDatasets operations, Dataset dataset, string defaultRetentionPolicy = default(string), CancellationToken cancellationToken = default(CancellationToken))
            {
